...
The app cannot answer, reject, intercept, or inspect native iPhone cellular calls. Apple does not expose those controls to third-party apps. Kalpana Drive can display approved contacts and request an outgoing call through the iPad system Phone/Continuity interface, but incoming cellular calls remain controlled by Apple's interface.
